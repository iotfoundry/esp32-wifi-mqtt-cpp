@echo off
REM ESP32 WiFi MQTT Client Setup Script for Windows
REM This script helps set up the configuration files for the ESP32 WiFi MQTT project
...
if not exist "esp32-wifi-mqtt.ino" (
...
REM Create wifi_config.h if it doesn't exist
...
REM Create mqtt_config.h if it doesn't exist
if not exist "mqtt_config.h" (
    echo Creating mqtt_config.h from template...
    copy mqtt_config_template.h mqtt_config.h
